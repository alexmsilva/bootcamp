...
class AppointmentController {
    ...
    async create(req, res) {
        ...
        /**
         * Checks id provider_id belongs to provider
         */
        ...
        /**
         * Checks if provider is the logged user
         */
        if (isProvider && req.userId == isProvider.id) {
            return res.status(401).json({ error: 'You can\'t create appointment with yourself' });
        }
         ...
         */
        const checkAvailability = await Appointment.findOne({ where: { provider_id, canceled_at: null, date } });
    ...
    async delete(req, res) {
        ...
        await Mail.sendMail({
            ...
            text: 'Um novo agendamento acaba de ser cancelado.'
        });
